...
export class ExpensesService {
  ...
  async create(createExpenseDto: CreateExpenseDto, userId: number): Promise<ExpenseResponse> {
    const { expense_date, ...otherFields } = createExpenseDto;
  ...
  async getTotalByType(userId: number, type: transaction_type_enum, startDate?: string, endDate?: string): Promise<{ total: number }> {
